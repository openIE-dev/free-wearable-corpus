---
title: sensor-microfluidic-sweat-collection ∩ algo-hydration-status
parent: Cross-cuts
layout: default
---

# Intersection cross-cut: `sensor-microfluidic-sweat-collection` ∩ `algo-hydration-status`

Axes: **sensors × algorithms**

**3 corpus entries disclose both tags.**

Earliest disclosure: 1965-08-01
