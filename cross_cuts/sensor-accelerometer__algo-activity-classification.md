---
title: sensor-accelerometer ∩ algo-activity-classification
parent: Cross-cuts
layout: default
---

# Intersection cross-cut: `sensor-accelerometer` ∩ `algo-activity-classification`

Axes: **sensors × algorithms**

**18 corpus entries disclose both tags.**
